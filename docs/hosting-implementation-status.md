...
| P2 contexts | Named customer contexts, protected credentials, endpoint selection guards, mutation target announcements | Stable identity binding and guarded base-environment provisioning are implemented locally; fresh-VPS execution, worker onboarding and complete customer readiness remain unqualified |
